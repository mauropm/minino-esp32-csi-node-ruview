...
static esp_err_t init_i2c_bus(void)
{
    ...
    /* Use Minino BSP I2C bus - already initialized by minino_bsp_init() */
    i2c_master_bus_handle_t i2c_bus = minino_bsp_get_i2c_bus();
    if (i2c_bus == NULL) {
        ESP_LOGE(TAG, "I2C bus not initialized by BSP");
        return ESP_ERR_INVALID_STATE;
    }

    s_i2c_initialized = true;
    ESP_LOGI(TAG, "Using Minino I2C bus (SDA=%d, SCL=%d)", I2C_SDA, I2C_SCL);
    return ESP_OK;
}
